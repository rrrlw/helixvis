...
draw_wheel(sequence$Seq[5], col = c("pink", "orange", "white", "black"),
...
draw_wenxiang(sequence$Seq[5])

# draw wenxiang diagram with custom color scheme
draw_wenxiang(sequence$Seq[5], col = c("pink", "orange", "white", "black"),
           labels = TRUE, label.col = "blue")
```
