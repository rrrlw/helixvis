...
Given the existence of databases listing thousands of peptides, all of which need to be visualized for manual inspection prior to wet-lab experiments, there is a need for software that allows for rapid programmatic construction of large numbers of publication-quality helical wheels and wenxiang diagrams.
